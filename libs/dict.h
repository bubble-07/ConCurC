...
typedef struct { \
 ...
 \
keyT##_##valT##_bucket keyT##_##valT##_bucket_make(keyT key, valT value) { \
...
typedef keyT##_##valT##_bucket_dynarray_dynarray keyT##_##valT##_dict; \
 \
keyT##_##valT##_bucket_dynarray keyT##_##valT##_initrow(keyT##_##valT##_bucket_dynarray in) { \
    return keyT##_##valT##_bucket_dynarray_make(1); \
} \
 \
keyT##_##valT##_dict keyT##_##valT##_dict_init(size_t size) { \
 ...
 \
keyT##_##valT##_dict keyT##_##valT##_dict_add(keyT##_##valT##_dict in, keyT##_##valT##_bucket to_add) { \
     size_t i = hash_##keyT(to_add.key) % in.size; \
     in.begin[i] = keyT##_##valT##_bucket_dynarray_add(in.begin[i], to_add); \
     return in; \
} \
valT keyT##_##valT##_dict_get(keyT##_##valT##_dict in, keyT key) { \
...
keyT##_##valT##_dict keyT##_##valT##_dict_addNoDup(keyT##_##valT##_dict in, keyT##_##valT##_bucket to_add) { \
